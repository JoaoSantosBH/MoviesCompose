...
fun PreviewDialog() {
    val onClick: () -> Unit = {}
    val setShow: (Boolean) -> Unit = {}
    val setValue: () -> Unit = {}
    val image = R.drawable.tmdbicon
    val buttonText = R.string.continue_label
    val title = R.string.compose_dialog_master_choice_title_dialog_text
    val info = "Texto  corpo"
    CustomDialogWithDraweableCompose(title, info, image, buttonText, onClick, setShow, setValue)
}